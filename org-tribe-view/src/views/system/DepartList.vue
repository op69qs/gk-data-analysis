    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <a-button type="primary" @click="handleExportXls('部门信息')">导出</a-button>
         <!--  <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
            <a-button type="primary">导入</a-button>
          </a-upload> -->
          <a-button title="删除多条数据" @click="batchDel" type="default">删除</a-button>
          <!--<a-button @click="refresh" type="default" :loading="loading">刷新</a-button>-->
        </a-row>
    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <div class="anty-form-btn">
          <a-button @click="emptyCurrForm" type="default" htmlType="button">重置</a-button>
          <a-button @click="submitCurrForm" type="primary" htmlType="button">修改并保存</a-button>
        </div>
      </a-card>
    </a-col>
    ...
    methods: {
      ...
      batchDel: function () {
        if (!this.currSelected.key) {
          ...
          this.$confirm({
            title: '确认删除',
            content: '确定要删除所选中的数据，以及子节点数据吗?',
            onOk: function () {
              deleteAction(that.url.deleteBatch, {ids: that.currSelected.key}).then((res) => {
                if (res.success) {
