<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline">
        <a-row :gutter="10">
          ...
          <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-col :md="6" :sm="24">
             <a-button type="primary" @click="searchQuery" style="margin-left: 18px">查询</a-button>
    ...
    <div class="table-operator" :md="24" :sm="24" style="margin: -46px 0px 10px 2px">
      <a-button @click="handleAdd" type="primary" style="margin-top: 16px">用户录入</a-button>
      <!--<a-button @click="handleEdit" type="primary" icon="edit" style="margin-top: 16px">用户编辑</a-button>-->
      <a-button @click="handleAddUserDepart" type="primary">添加已有用户</a-button>
