                    ...
                    <a-col :md="8" :sm="8">
                        <a-form-item :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}" label="指标类型">
                            <a-select v-model="queryParam.type" placeholder="请输入指标类型">
                                <a-select-option :value="d.id" v-for="d in queryOption" :key="d.id">{{d.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-item>
                    </a-col>
                    <a-col :md="8" :sm="8">
                        ...
                        >
                            <a-select v-model="queryParam.INDEX_DIMNSN" placeholder="请输入指标维度">
                                <a-select-option :value="d.id" v-for="d in queryOption1" :key="d.id">{{d.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-item>
                    </a-col>
                    <a-col :md="8" :sm="8">
                        ...
                        >
                            <a-select v-model="queryParam.INDEX_PERIOD" placeholder="请输入指标周期">
                                <a-select-option :value="d.id" v-for="d in queryOption2" :key="d.id">{{d.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-item>
                    </a-col>
...
<script>
    ...
    import {getPublicIndexManageList, deletePublicIndex, historyRunBatch} from '@/api/nationalTreasury'
    ...
    export default {
        ...
        created() {
            ...
            getPublicIndexManageList({pageNo: 1, pageSize: 10, USERID: userId}).then(res => {
