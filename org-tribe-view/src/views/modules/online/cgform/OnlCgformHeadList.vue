<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button @click="doCgformButton" type="primary" style="margin-left:8px">自定义按钮</a-button>
      <a-button @click="doEnhanceJs" type="primary" style="margin-left:8px">JS增强</a-button>
      <a-button @click="doEnhanceSql" type="primary" v-has="'online:sql'" style="margin-left:8px">SQL增强</a-button>
      <a-button @click="doEnhanceJava" type="primary" style="margin-left:8px">Java增强</a-button>
      <a-button @click="importOnlineForm" type="primary" style="margin-left:8px">从数据库导入表单</a-button>
      <a-button @click="goGenerateCode" v-has="'online:goGenerateCode'" type="primary" style="margin-left:8px">代码生成</a-button>
