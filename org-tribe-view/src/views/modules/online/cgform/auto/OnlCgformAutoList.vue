<template>
  <a-card :bordered="false" style="height: 100%">
        ...
        <a-row :gutter="24" v-if="queryInfo && queryInfo.length>0">
          ...
          <a-col :md="6" :sm="8">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              <a-button type="primary" @click="searchByquery">查询</a-button>
    ...
    <div class="table-operator">
      <a-button v-if="buttonSwitch.add" @click="handleAdd" type="primary">新增</a-button>
      <a-button v-if="buttonSwitch.import" @click="handleImportXls" type="primary" style="margin-left:8px">导入</a-button>
      <a-button v-if="buttonSwitch.export" @click="handleExportXls" type="primary" style="margin-left:8px">导出</a-button>
