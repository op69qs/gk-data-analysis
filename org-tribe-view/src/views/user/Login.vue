  ...
  <div class="main">
    ...
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      <div style="text-align: center;padding-top: 20px;">
        <div style="padding-bottom: 20px;color:#F5F5F5;font=size:16px;font-size: 16px;font-weight: normal;">
          <span style="border-bottom: 1px #F5F5F5F5 solid;padding-bottom: 5px;display: inline-block;width: 26%;">
             欢迎登录
          </span>
        </div>
        <a-form-item>
      ...
      <!--<a-tabs
        ...
        &lt;!&ndash;<a-tab-pane key="tab1" tab="国库数据分析与综合应用平台">


          &lt;!&ndash;<a-row :gutter="0">
            <a-col :span="14">
              <a-form-item>
                <a-input
      ...
      <a-form-item>
        <a-checkbox v-model="formLogin.rememberMe">保存信息</a-checkbox>
      </a-form-item>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        currentUsername: "",
        validate_status: "",
        url_view:'portal/userApi/getUserByNameAndPwd'
      }
    },
    created() {
