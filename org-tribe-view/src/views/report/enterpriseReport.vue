            ...
            <a-form layout="inline">
                <a-row :gutter="24">
                    ...
                    <a-col :md="6" :sm="24" style="text-align: right">
                        ...
                        <a-button style="margin-left: 8px" @click="handleExportXls(queryParam.mark == 0 ? '税收收入本期分企业分税种统计表' : '税收收入累计分企业分税种统计表')">导出</a-button>
                    </a-col>
                </a-row>
            </a-form>
        </div>
        <h1 style="text-align: center">{{queryParam.mark == '0' ? '本期' : '累计'}}企业</h1>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columns: [],
                url: {
                    list: '/fixedReport/kydReportController/getEnterprise',
                    exportXlsUrl: '/fixedReport/kydReportController/excelEnterprise'
                },
                guokuName: '',
                report_type:'enterpriseReport'
            }
        },
        watch:{
        },
        ...
        methods: {
            ...
            setQuery() {
                this.queryParam = {
                    ...
                    amtUnit:'100000000',
                    mark: '0',
                    report_type: 'enterpriseReport', // 报表类型,
                    // PROJECT:sub.split(','),
                }
            },
