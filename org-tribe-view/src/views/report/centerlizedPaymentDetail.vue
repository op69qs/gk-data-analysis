<template>
    <a-card :bordered="false" class="card-area">
                ...
                <a-row :gutter="24">
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                        <template slot="label">代理银行</template>
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                        <template slot="label">预算单位代码</template>
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                        <template slot="label">预算单位</template>
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                        <template slot="label">收款人账号</template>
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                        <template slot="label">收款人名称</template>
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                            <a-select v-model="queryParam.C_AUTOAUDITSTATE" placeholder="请选择第一审核状态">
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                            <a-select v-model="queryParam.C_HANDAUDITSTATE" placeholder="请选择第二审核状态">
                                <a-select-option value="1">审核通过</a-select-option>
                                <a-select-option value="2">审核不通过</a-select-option>
                            </a-select>
                        </a-form-item>
                    ...
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                            <a-select v-model="queryParam.S_TWOTIMEDIFFERENCE" placeholder="请选择两次审核时差">
                                <a-select-option value="0">2小时内</a-select-option>
                                <a-select-option value="1">2-4小时</a-select-option>
                                <a-select-option value="2">4-6小时</a-select-option>
                                <a-select-option value="3">6小时以上</a-select-option>
                            </a-select>
                        </a-form-item>
                    </a-col>
                    <a-col :md="6" :sm="10">
                        <a-form-item
                                ...
                                :wrapperCol="{ span: 16, offset: 1 }"
                        >
                            <!-- <a-select v-model="queryParam.S_AUDITREASON" placeholder="请选择审核失败原因">
                                <a-select-option value="1">超出预算计划</a-select-option>
                                <a-select-option value="2">关注账户提示未通过</a-select-option>
                                <a-select-option value="3">资金支付文件依据不足</a-select-option>
                                <a-select-option value="4">收款账户不符合规定</a-select-option>
                                <a-select-option value="5">其他原因</a-select-option>
                            </a-select> -->
                            <a-input v-model="queryParam.S_AUDITREASON" placeholder="请输入审核失败原因"/>
                        </a-form-item>
                    </a-col>
                    ...
                    <a-col :md="6" :sm="24" style="text-align: right">
                        ...
                        <!-- <a-button style="margin-left: 8px" @click="handleExportXls('集中支付业务明细查询表')">导出Excel</a-button> -->
                        <a-button style="margin-left: 8px" @click="handleExportTxt('集中支付业务明细查询表')">导出Txt</a-button>
                    </a-col>
                </a-row>
            </a-form>
        </div>
        <h1 style="text-align: center">集中支付业务明细查询表</h1>
        ...
        <a-col :md="24" style="position:absolute;text-align:center;" v-if="queryParam.S_STARTTIME">
          业务期间：
          <span>{{queryParam.S_STARTTIME.format('YYYY-MM-DD')}}~{{queryParam.S_ENDTIME.format('YYYY-MM-DD')}}</span>
        </a-col>
        <a-col
          :md="8"
          style="position:absolute;right:0px;text-align:right;"
        >
          金额单位：{{queryParam.S_AMTUNIT === '1' ? '元' : (queryParam.S_AMTUNIT === '10000' ? '万元' : '亿元'),}}
        ...
        <a-col :md="24" style="position:absolute;text-align:center;" v-if="queryParam.S_STARTTIME">
          制表人：
          <span>{{JSON.parse(localStorage.pro__Login_Userinfo).value.username}}</span>
        </a-col>
        <a-col
          :md="8"
          style="position:absolute;right:0px;text-align:right;"
        ...
        data() {
            return {
                ...
                columns: [{
                        ...
                        title: '第一审核状态',
                        align: 'center',
                        dataIndex: 'C_AUTOAUDITNAME',
                        width:300
                    },{
                        title: '第一审核时间',
                        align: 'center',
                        dataIndex: 'T_AUTOAUDITTIME',
                        width:300
                    },{
                        title: '第二审核状态',
                        align: 'center',
                        dataIndex: 'C_HANDAUDITNAME',
                        width:300
                    },{
                        title: '第二审核时间',
                        align: 'center',
                        dataIndex: 'T_HANDAUDITTIME',
                        width:300
                    },{
                        title: '审核失败原因',
                        align: 'center',
                        dataIndex: 'S_AUDITREASON',
                        width:300
                    },{
                        title: '摘要',
                        align: 'center',
                ...
                url: {
                    list: '/fixedReport/centralizedPaymentController/reportDate',
                    exportXlsUrl: '/fixedReport/centralizedPaymentController/exportToTxt',
                    exportTxtUrl: '/fixedReport/centralizedPaymentController/exportToTxt'
                },
                guokuName: ''
            }
        },
