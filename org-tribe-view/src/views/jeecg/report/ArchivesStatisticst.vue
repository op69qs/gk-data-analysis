        ...
        <a-row :gutter="24">
          ...
          <a-col :span="14">
            <a-form v-if="barType === 'month' && false" layout="inline" style="margin-top: -4px">
              ...
              <a-button style="margin-top: 2px" type="primary" @click="queryDatebar">查询</a-button>
              <a-button style="margin-top: 2px;margin-left: 8px" @click="searchReset">重置</a-button>
            </a-form>
          </a-col>
          ...
          <a-col :span="14">
            <a-form v-if="pieType === 'month' && false" layout="inline" style="margin-top: -4px">
              <a-row :gutter="24">
                ...
                <a-button style="margin-top: 2px" type="primary" @click="queryDatepie">查询</a-button>
                <a-button style="margin-top: 2px;margin-left: 8px" @click="searchReset">重置</a-button>
              </a-row>
            </a-form>
          </a-col>
