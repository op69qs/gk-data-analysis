...
public interface ReportService {
     ...
     * @return
     */
    List<Map<String, Object>> getAreaReport(PageData  params);
    List<Map<String, Object>> getTextAndParams(PageData  params);
    Map<String, Object> getHtmlReport(PageData  params);
    Map<String, Object> getMonthlyReport(PageData  params);
    /**
     * 获取生成报告的报表参数信息
     * @param params
     * @return
    ...
    List<Map<String, Object>> getAreaParams(PageData  params);
    List<Map<String, Object>> getNumParams(PageData  params);
    void insertFact(Map  params);
    void updateEntityReport(Map  params);
