...
public class SqlUtils {
    ...
    public static final String DATABSE_TYPE_VASTBASE = "vastbase";
    ...
    public static boolean dbTypeIsPostgre(String dbType) {
        return dbTypeIf(dbType, DATABSE_TYPE_POSTGRE, DATABSE_TYPE_VASTBASE, DataBaseConstant.DB_TYPE_POSTGRESQL_NUM);
    }
