...
public class IndexPieController extends BaseController {
    ...
    public Map<String, Object> saveIndexPie(
        ...
        try {
            ...
            log.info(
                    "saveIndexPie started, schemeId={}, chartType={}, contentLength={}",
                    schemeId,
                    chartType,
                    contentLength);
            ...
            log.info(
                    "saveIndexPie scheme lookup completed, schemeId={}, elapsedMs={}",
                    schemeId,
            ...
            log.info(
                    "saveIndexPie gallery insert completed, schemeId={}, elapsedMs={}, totalElapsedMs={}",
                    schemeId,
            ...
            log.error(
                    "saveIndexPie failed, schemeId={}, chartType={}, contentLength={}, totalElapsedMs={}",
                    schemeId,
                    chartType,
                    contentLength,
                    (System.nanoTime() - startedAt) / 1_000_000L,
