...
public interface ConfigMapper {
     ...
     * @Description 调用优云告警汇总存储过程
     */
    void callUcloudAlarmProcedure(@Param("params") Map<String, Object> map);

    /**
     * @Author haojiang
     * @Date 2020/11/21 15:13
     * @Description 调用优云指标汇总存储过程
     */
    void callUcloudIndexProcedure(@Param("params") Map<String, Object> map);

    /**
     * @Author haojiang
     * @Date 2020/11/21 15:13
     * @Description 调用UPM异常行为告警汇总存储过程
     */
    void callUPMAlarmLogProcedure(@Param("params") Map<String, Object> map);

    /**
     * @Author haojiang
     * @Date 2020/11/21 15:13
     * @Description 调用UPM网络性能告警汇总存储过程
     */
    void callUPMnetperLogProcedure(@Param("params") Map<String, Object> map);

    /**
     * @Author haojiang
     * @Date 2020/11/21 15:13
     * @Description 调用UPM指标汇总存储过程
     */
    void callUPMIndexProcedure(@Param("params") Map<String, Object> map);
}
