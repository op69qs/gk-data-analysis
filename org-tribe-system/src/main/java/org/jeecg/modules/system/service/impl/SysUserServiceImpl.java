...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
	...
	@Override
	public List<Map<String, Object>> getUserList(Map pd) {
		return userMapper.getUserList(pd);
	}

	@Override
	public int getUserListCount(Map pd) {
		return userMapper.getUserListCount(pd);
	}
	...
	@Override
	public void addUserGuoku(Map params) {
		  userMapper.addUserGuoku(params);
	}

	@Override
	public void DelUserGuoku(Map params) {
		userMapper.DelUserGuoku(params);
	}
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	 ...
	 * @return
	 */
	public void updateUserUpdateTime(String login_id){
		userMapper.updateUserUpdateTime(login_id);
	}
