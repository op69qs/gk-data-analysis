...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		//GK-Nexus OAuth2.0 callback
		filterChainDefinitionMap.put("/sys/oauth/callback", "anon");
		...
		//浏览器下载
		filterChainDefinitionMap.put("/Firefox Setup 74.0-32.exe", "anon");
		filterChainDefinitionMap.put("/Firefox Setup 74.0.exe", "anon");
		filterChainDefinitionMap.put("/Firefox Setup 52.9.0esr(xp32).exe", "anon");
		filterChainDefinitionMap.put("/Firefox Setup 52.9.0esr(xp64).exe", "anon");
