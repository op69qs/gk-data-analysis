...
public class CreateExcel_2 {
    ...
    public static boolean createInspectStatisticsTable(
            ...
            List<String> titlelist, List<String> titlelist_2, List<String> titlelist_3,
        ...
        try {
            ...
            for (int i = 0; i < len_1; i++) {
                ...
                cellSub_2.setCellStyle(setCellStyle(wb));
                sheet.addMergedRegion(new CellRangeAddress(1, 2, i, i));

            }
            for (int j = 0; j < len_2; j++) {
                Cell cellSub = row1.createCell(j * 3 + 7);
                Cell cellSub_1 = row1.createCell(j * 3 + 8);
                Cell cellSub_2 = row1.createCell(j * 3 + 9);
                cellSub.setCellValue(titlelist_2.get(j));
                cellSub.setCellStyle(setCellStyle(wb));
                cellSub_1.setCellStyle(setCellStyle(wb));
                cellSub_2.setCellStyle(setCellStyle(wb));
                sheet.addMergedRegion(new CellRangeAddress(1, 1, j * 3 + 7, j * 3 + 9));
            }
            // 添加表头
            for (int k = 0; k < len_3; k++) {
                Cell cellSub = row2.createCell(k + 7);
    ...
    public static boolean createInspectSelfSumTable(
        ...
        try {
            ...
            cell_2_1.setCellStyle(setCellStyle(wb));
            cell_2_1_1.setCellStyle(setCellStyle(wb));
            cell_2_1_2.setCellStyle(setCellStyle(wb));
            cell_2_1_3.setCellStyle(setCellStyle(wb));
            cell_2_1_4.setCellStyle(setCellStyle(wb));
            cell_2_1_5.setCellStyle(setCellStyle(wb));
            cell_2_1_6.setCellStyle(setCellStyle(wb));
            cell_2_1_7.setCellStyle(setCellStyle(wb));
            cell_2_1_8.setCellStyle(setCellStyle(wb));
            ...
            cell_2_2.setCellStyle(setCellStyle(wb));
            cell_2_2_1.setCellStyle(setCellStyle(wb));
            cell_2_2_2.setCellStyle(setCellStyle(wb));
            ...
            cell_2_3.setCellStyle(setCellStyle(wb));
            cell_2_3_1.setCellStyle(setCellStyle(wb));
            cell_2_3_2.setCellStyle(setCellStyle(wb));
            ...
            cell_2_4.setCellStyle(setCellStyle(wb));
            cell_2_4_1.setCellStyle(setCellStyle(wb));
            cell_2_4_2.setCellStyle(setCellStyle(wb));
            cell_2_4_3.setCellStyle(setCellStyle(wb));
            cell_2_4_4.setCellStyle(setCellStyle(wb));


            Cell cell_3_1 = row3.createCell(5);
            Cell cell_3_1_1 = row4.createCell(5);
            cell_3_1.setCellValue("分库");
            cell_3_1.setCellStyle(setCellStyle(wb));
            cell_3_1_1.setCellStyle(setCellStyle(wb));


            Cell cell_3_2 = row3.createCell(6);
            Cell cell_3_2_1 = row3.createCell(7);
            cell_3_2.setCellValue("中心支库");
            cell_3_2.setCellStyle(setCellStyle(wb));
            cell_3_2_1.setCellStyle(setCellStyle(wb));


            Cell cell_3_3 = row3.createCell(8);
            Cell cell_3_3_1 = row3.createCell(9);
            cell_3_3.setCellValue("支库");
            cell_3_3.setCellStyle(setCellStyle(wb));
            cell_3_3_1.setCellStyle(setCellStyle(wb));
    ...
    public static boolean createTemproraySumTable(
        ...
        try {
            ...
            for (int i = 0; i < clns.length; i++) {
                ...
                cell_temp.setCellStyle(setCellStyle(wb));
            }
