...
public class DateUtil {
    ...
    public static String getHalfDate(String endDate){
        ...
        try {
            ...
            stratDate = format.format(calendar.getTime());
     ...
     * @return
     */
    public static String getAfterDayDateReturnYYYY_MM_DD(String days) {
        int daysInt = Integer.parseInt(days);
